        ...
        <div id="toolbar">
          <div class="form-inline">
            <div class="form-group clearfix">
              <label class="control-label  pull-left">选择信息类</label>
              <div class=" pull-left" style="margin-left:10px;width:250px;">
                <select id="infoT" name="infoT" data-placeholder=" " class="chosen-select" style="width:350px;" tabindex="4" required>
                  <option value=""></option>
                  <option value="1">个人信用</option>
                  <option value="2">法人信用</option>
                </select>
              </div>
              <div class="pull-left" style="margin-left:10px;">
                <button type="button" onclick=" $('#dicList').bootstrapTable('refresh');" class="btn btn-primary">搜索
                </button>
                <c:if test="<%=!ServiceUtil.haveAdd(\"/backstage/model/houseModel/index?types=4\") %>">
  ...
  <div id="layer_form" style="display: none;" class="ibox-content">
    <form method="post" class="form-horizontal" id="eform">
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label">信息分类：</label>
        <div class="col-sm-7">
      ...
      <div class="form-group showinfor" >
        <label class="col-sm-3 control-label">提供单位：</label>
        <div class="col-sm-7">        
      ...
      <div class="form-group showinfor" >
        <label class="col-sm-3 control-label">相对人：</label>
        <div class="col-sm-7">        
          <select name="infoName" data-placeholder=" " class="chosen-select" style="width:350px;" tabindex="4" required>
            <option value=""></option>
      ...
      <div class="form-group">
        <label class="col-sm-3 control-label">提供时间：</label>
        <div class="col-sm-7">
          <input class="form-control form_datetime" size="16" type="text" name="stime" value="" required/>
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-3 control-label">有效期：</label>
        <div class="col-sm-7">
          <input class="form-control form_datetime" size="16" type="text" name="etime" value="" required/>
        </div>
      </div>
      <div class="form-group">
        <label class="col-sm-3 control-label">公开属性：</label>
        <div class="col-sm-7">        
          <select name="options" data-placeholder=" " class="chosen-select" style="width:350px;" tabindex="4" required>
            <option value=""></option>
...
$(formId).form({
  url: url + 'insertAjax?houseTypes=4',
  onSubmit: function() {
...
var TableInit = function() {
  ...
  oTableInit.Init = function() {
    $(tableId).bootstrapTable({
      url: '${base}/backstage/model/houseModel/listAjax?houseTypes=4', //请求后台的URL（*）
      method: 'post', //请求方式（*）
      contentType: "application/x-www-form-urlencoded",
...
function doFormatter(value, row, index) {
  ...
  <c:if test="<%=!ServiceUtil.haveEdit(\"/backstage/model/houseModel/index?types=4\") %>">
  html += '<button type="button" class="btn btn-white" onclick="editRow(\'' + row.idForShow + '\')"><i class="fa fa-pencil"></i>&nbsp;修改</button>';
  </c:if>
  <c:if test="<%=!ServiceUtil.haveDel(\"/backstage/model/houseModel/index?types=4\") %>">
