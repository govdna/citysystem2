...
<body class="white-bg skin-<%=ServiceUtil.getThemeType(10)%>">
          ...
          <div class="form-inline">
            <div class="form-group clearfix">
              ...
              <div class="pull-left" style="margin-left:10px;">
                ...
                <c:if test="<%=!ServiceUtil.haveAdd(\"/backstage/model/houseModel/index?types=1\") %>">
  ...
  <div id="layer_form" style="display: none;" class="ibox-content">
    <form method="post" class="form-horizontal" id="eform">
      ...
      <div class="form-group showinfor" id="dicTree3" style="display: none;" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-6">
              <div class="input-group">
                <input type="text" placeholder="请输入中文名称" name="keyword" class="form-control"> 
...
$(formId).form({  
    url: url+'insertAjax?houseTypes=1',  
    onSubmit: function(){
      return $(formId).valid();
    },
...
var TableInit = function () {
    ...
    oTableInit.Init = function () {
        $(tableId).bootstrapTable({
            url: '${base}/backstage/model/houseModel/listAjax?houseTypes=1',         //请求后台的URL（*）
            method: 'post',                      //请求方式（*）
            contentType: "application/x-www-form-urlencoded",
...
function doFormatter(value, row, index){
  ...
  <c:if test="<%=!ServiceUtil.haveEdit(\"/backstage/model/houseModel/index?types=1\") %>">
  html+='<button type="button" class="btn btn-white" onclick="editRow(\''+row.idForShow+'\')"><i class="fa fa-pencil"></i>&nbsp;修改</button>';
  </c:if>
  <c:if test="<%=!ServiceUtil.haveDel(\"/backstage/model/houseModel/index?types=1\") %>">
