...
int c1 = ServiceUtil.getService("GovApplicationSystemService").count(ServiceUtil.buildBean("GovApplicationSystem@isDeleted=0&companyId="+pageContext.getAttribute("cpid")));
...
int c4 =ServiceUtil.getService("DataElementService").count(ServiceUtil.buildBean("DataElement@classType=1&status=0&isDeleted=0&companyId="+pageContext.getAttribute("cpid")));
