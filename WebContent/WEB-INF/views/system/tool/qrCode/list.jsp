...
<!-- 二维码引入js -->
<script type="text/javascript" src="${base}/static/js/jquery/jquery.qrcode.min.js"></script>
</head>
<body>
                    ...
                    <div class="widget-box">
                      ...
                      <div class="widget-body">
                        <div class="widget-main">
                          ...
                          <div id="code">
                            <img id="encoderImgId" cache="false" src="${base}/static/images/system/2qrcodeDefault.png" width="235px" height="235px" />
                          </div>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="widget-body">
                        <div class="widget-main">
                            <form id="uploadForm" method="post" enctype="multipart/form-data" onsubmit="return false;">
                              <input type="file" id="upload2code" name="codeFile"  onchange="JY.File.fileType(this,'gif|png|jpg|jpeg')" />
                            </form>
...
<script src="${base}/static/js/system/tool/qrcode.js"></script>
</body>
</html>