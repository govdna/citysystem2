...
<%@include file="../../common/dialog.jsp" %>
  ...
  <!--用来存放文件信息-->
    ...
    <!-- style只为显示效果，真正用请去掉 -->
    <div>存放位置:
      <input style="width:100%" id="savePath" readonly="readonly" type="text" name="savePath">
    </div>
  </div>
...
jQuery(function() {
  ...
  uploader = WebUploader.create({
    ...
    // 文件接收服务端。
    server: base + '/backstage/tool/webuploader/uploadFile',
    // 选择文件的按钮。可选。
  ...
  uploader.on('uploadProgress', function(file, percentage) {
    ...
    $li.find('p.state').text('上传中<i class="fa fa-refresh fa-spin" style="margin-left:10px;"></i>');
