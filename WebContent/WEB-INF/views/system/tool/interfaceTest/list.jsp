              ...
              <div class="row">
                <div class="col-xs-12">
                  <form id="interfaceForm" class="form-horizontal" method="POST" onsubmit="return false;">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-9">
                        <span class="input-icon" style="width:100%">
                            <input jyValidate="required" name="serverUrl" type="text" style="width:100%">
                    ...
                    <hr>
                    <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right">服务器响应：
                        <font id="serverTime" color="red">-</font>毫秒 </label>
                      <label class="col-sm-3 control-label no-padding-right">客户端请求：
                        <font id="clientTime" color="red">-</font>毫秒 </label>
                    </div>
                  </form>
                </div>
              </div>
...
<script src="${base}/static/js/system/tool/interfaceTest.js"></script>
</body>
</html>