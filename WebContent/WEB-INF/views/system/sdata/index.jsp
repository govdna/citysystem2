          ...
          <div class="form-inline">
            ...
            <div class="form-group" style="margin-left: 15px;">
              <div class="text-center">
               <c:if test="<%=!ServiceUtil.haveAdd(\"/backstage/sysDataElement/index?sys=1\") %>">            	
...
function doFormatter(value, row, index) {
  ...
  <c:if test="<%=!ServiceUtil.haveEdit(\"/backstage/sysDataElement/index?sys=1\") %>">    
  html += '<button type="button" class="btn btn-white" onclick="editRow(\'' + row.idForShow + '\')"><i class="fa fa-pencil"></i>&nbsp;修改</button>';
  </c:if>
  <c:if test="<%=!ServiceUtil.haveDel(\"/backstage/sysDataElement/index?sys=1\") %>">     
