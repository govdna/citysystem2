	     ...
	     <div class="panel-container  col-xs-4">
		    <div class="panel panel-default panel-item">
		    	...
		    	<div class="panel-body content">
		    		<ul>
		    			<li><p class="col-xs-8 text-right">开放信息资源数量：</p>  <p class="col-xs-4 text-left"><span><%=ServiceUtil.getService("InformationResourceService").count(ServiceUtil.buildBean("InformationResource@status=0&isDeleted=0&value11=1&value3="+pageContext.getAttribute("cid")))%></span></p></li>
		    			<li><p class="col-xs-8 text-right">不开放信息资源数量：</p><p class="col-xs-4 text-left"><span><%=ServiceUtil.getService("InformationResourceService").count(ServiceUtil.buildBean("InformationResource@status=0&isDeleted=0&value11=2&value3="+pageContext.getAttribute("cid")))%></span></p></li>		    			
		    		</ul>
		    	</div>
		    </div>
	    </div>
