   ...
   <c:forEach items="${jsa}" var="company" >
	   	<div class="panel-container col-xs-4">
	        <div class="panel panel-default  panel-item">
	          <div class="panel-heading text-center text-hidden">${company.sname}</div>
	          <div class="panel-body content">
	            ...
	            <li  >
	              ...
	              <li  >
	                <p class="col-xs-8 text-right">部门数量：</p> 
	                <p class="col-xs-4 text-left"><span>${company.ccount}</span></p>
	              </li>	              
	            </ul>
	          </div>
	        </div>
