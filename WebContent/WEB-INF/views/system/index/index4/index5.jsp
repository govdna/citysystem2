...
<link rel="stylesheet" href="${base}/static/css/skin/skin-4-5.css">
...
.header {
  ...
  .menu-list-container .menu-item.menu-item-1 {
    top: 0px;
    left: 0px;
  }
  ...
  .menu-list-container .menu-item.menu-item-5 {
    top: 0px;
    right: 0px;
  }
...
function autoMargin () {
  ...
  var space = Math.floor((containerWidth - (itemWidth * itemLength)) / (itemLength - 1));
  console.log('space='+space);
  console.log('containerWidth='+containerWidth+';itemWidth='+itemWidth);
  item.each(function (index, value) {
    if (index < itemLength && index) {
      var left = index * itemWidth + index * space
      $(this).css('left', left);
    }
  });
}
