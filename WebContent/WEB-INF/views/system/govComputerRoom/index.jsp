...
<body class="white-bg skin-<%=ServiceUtil.getThemeType(10)%>">
            ...
            <div class="form-group pull-left">
             ...
             <div class="btn-group">
              ...
              <div class="form-group"  style="margin-left:10px;">
               ...
               <c:if test="<%=!ServiceUtil.haveExp(\"/backstage/govComputerRoom/index\") %>">
  ...
  <div id="layer_form" style="display: none;" class="ibox-content">
    <form method="post" class="form-horizontal" id="eform">
	  ...
	  <c:set var="simpleFields" value="<%=ServiceUtil.getService(\"SimpleFieldsService\").find(ServiceUtil.buildBean(\"SimpleFields@isDeleted=0&className=GovComputerRoom\"),\"list_no\",\"asc\")%>"/>
  ...
  <div id="download_div" style="display: none;" class="ibox-content">
    <form method="post" class="form-horizontal" id="downloadForm">
       <c:if test = "${MyFunction:getMaxScope(\"/backstage/govComputerRoom/index\")==100}" >
  ...
  <div id="import_form" style="display: none;" class="ibox-content">
    <form method="post" class="form-horizontal" id="importForm">
      <div class="form-group" style="padding:10px;">
        <div class="alert alert-info">请先下载机房清单模版，根据模版填写数据。
         <a class="alert-link"  href="${base}/upload/excel/computerExcel.xlsx">Excel模版下载</a>.<br /> 如导入数据量大，上传请耐心等待！
        </div>
...
function doFormatter(value, row, index)
{
	...
	<c:if test="<%=!ServiceUtil.haveEdit(\"/backstage/govComputerRoom/index\") %>">
	html+='<button type="button" class="btn btn-white" id="edit"  onclick="editRow(\''+row.idForShow+'\')"><i class="fa fa-pencil"></i>&nbsp;修改</button>';
	</c:if>
	<c:if test="<%=!ServiceUtil.haveDel(\"/backstage/govComputerRoom/index\") %>">
