      ...
      <div class="ibox-content ibox-content-change">
        <div class="btn-group hidden-xs" id="toolbar" role="group"  style="display: block;">
          <ul id="deper" class="clearfix">
            ...
            <li class="col-sm-4">
            <span class="name label label-success" value="1" dt="2">向社会开放
            <c:set  var="count"   value="<%=ServiceUtil.getService(\"InformationResourceService\").count(ServiceUtil.buildBean(\"InformationResource@status=0&value11=1\"))%>"/>
            <c:if test="${count > 0}">
            <i>
              ${count}
            </i>
          ...
          <a href='${base}/backstage/information/resource/shares'><span class="label" >返回</span></a>  
          </div>
        </div>
