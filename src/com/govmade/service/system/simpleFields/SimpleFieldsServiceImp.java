package com.govmade.service.system.simpleFields;
...
* @date 2017年3月1日 上午10:04:45   
* @company (开发公司) 国脉海洋信息发展有限公司
* @copyright (版权) 本文件归国脉海洋信息发展有限公司所有
* @since (该版本支持的JDK版本) 1.7
* @Title: SimpleFieldsServiceImp.java
* @Package com.govmade.service.system.SimpleFields
* @version V1.0   
*/
@Service("SimpleFieldsService")
public class SimpleFieldsServiceImp extends GovmadeBaseServiceImp<SimpleFields> implements SimpleFieldsService{
