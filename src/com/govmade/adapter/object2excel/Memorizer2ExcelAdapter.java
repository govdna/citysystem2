...
public class Memorizer2ExcelAdapter extends Object2ExcelAdapter<GovMemorizer> {
	...
	public Memorizer2ExcelAdapter(List<GovMemorizer> list, String[] fields,Map<String,DataHandler> map) {
		super(list);
		this.fields = fields;
		this.map=map;
	}
	...
	@Override
	public String[] object2StrArray(GovMemorizer t) {
		String[] str = new String[fields.length];
		for(int i=0;i<fields.length;i++){
