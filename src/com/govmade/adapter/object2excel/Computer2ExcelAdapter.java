...
public class Computer2ExcelAdapter extends Object2ExcelAdapter<GovComputerRoom> {
	...
	public Computer2ExcelAdapter(List<GovComputerRoom> list, String[] fields,Map<String,DataHandler> map) {
		super(list);
		this.fields = fields;
		this.map=map;
	}
	...
	public String[] getTitle() {
		...
		sf.setIsDeleted(0);
		sf.setClassName("GovComputerRoom");
	...
	@Override
	public String[] object2StrArray(GovComputerRoom t) {
		String[] str = new String[fields.length];
		for(int i=0;i<fields.length;i++){
