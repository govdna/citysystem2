...
public class HouseModel2ExcelAdapter extends Object2ExcelComplexAdapter<HouseModel> {
	private HouseModelFieldsService service = (HouseModelFieldsService) ServiceUtil
			.getService("HouseModelFieldsService");
	...
	public HouseModel2ExcelAdapter(List<HouseModel> list, String[] fields,String[] deFields,Map<String,DataHandler> map) {
		super(list);
		this.fields = fields;
	...
	public String[] getTitle() {
		List<HouseModelFields> list = service.find(new HouseModelFields());
	...
	public String[] object2StrArray(HouseModel t) {
	...
	@Override
	public List<String[]> object2List(HouseModel t) {
		DataList dataList=new DataList();
		dataList.setHouseModelId(t.getId());
		List<DataElement> list = dataElementService.getDElistByHouseModelId(dataList);
