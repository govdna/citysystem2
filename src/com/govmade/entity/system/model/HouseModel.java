 ...
 * @date 2016年12月12日 上午9:57:49
 * @Title: HouseManager.java
 */

@Alias("HouseModel")
public class HouseModel extends IdBaseEntity {

	/**
	 * 
	 */
	private static final long serialVersionUID = -6449593495979073568L;
	private Integer houseTypes; // 库类
	private Integer infoTypes; // 信息类
	private String infoName; // 专项信息名称
	private Integer informationResId; // 信息资源名称
	private String inforCode; // 信息资源代码
	private String dataElementId; // 一对多关联表
	private Integer department; // 部门
	private String stime; // 开始时间
	private String etime; // 结束时间
	private String options; // 属性
